...
export function ShadcnSidebar() {
  ...
  return (
    <>
      <Sidebar className="h-[40px] md:h-auto px-1 flex flex-row md:flex-col gap-1">
        <SidebarHeader className="flex flex-row md:flex-col items-center justify-between w-full h-auto md:w-auto md:h-full">

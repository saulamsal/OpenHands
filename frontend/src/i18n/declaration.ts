...
export enum I18nKey {
  ...
  MICROAGENT$NO_GIT_PROVIDERS_TITLE = "MICROAGENT$NO_GIT_PROVIDERS_TITLE",
  MICROAGENT$NO_GIT_PROVIDERS_DESCRIPTION = "MICROAGENT$NO_GIT_PROVIDERS_DESCRIPTION",
  MICROAGENT$CONFIGURE_GIT_PROVIDERS = "MICROAGENT$CONFIGURE_GIT_PROVIDERS",
  ...
  SETTINGS$TEST_LLM = "SETTINGS$TEST_LLM",
  SETTINGS$TESTING = "SETTINGS$TESTING",
  SETTINGS$LLM_TEST_SUCCESS = "SETTINGS$LLM_TEST_SUCCESS",
  ...
  SETTINGS$THEME_AUTO = "SETTINGS$THEME_AUTO",
  ...
  SETTINGS$MANAGE_CONFIGURATIONS = "SETTINGS$MANAGE_CONFIGURATIONS",
  SETTINGS$ADD_LLM_CONFIGURATION = "SETTINGS$ADD_LLM_CONFIGURATION",
  SETTINGS$EDIT_LLM_CONFIGURATION = "SETTINGS$EDIT_LLM_CONFIGURATION",
  SETTINGS$LLM_CONFIGURATION_CREATED = "SETTINGS$LLM_CONFIGURATION_CREATED",
  SETTINGS$LLM_CONFIGURATION_UPDATED = "SETTINGS$LLM_CONFIGURATION_UPDATED",
  SETTINGS$CONFIGURATION_NAME = "SETTINGS$CONFIGURATION_NAME",
  SETTINGS$CONFIGURATION_NAME_PLACEHOLDER = "SETTINGS$CONFIGURATION_NAME_PLACEHOLDER",
  SETTINGS$PROVIDER = "SETTINGS$PROVIDER",
  SETTINGS$ADD_API_KEY = "SETTINGS$ADD_API_KEY",
  SETTINGS$SELECT_PROVIDER = "SETTINGS$SELECT_PROVIDER",
  SETTINGS$MODEL = "SETTINGS$MODEL",
  SETTINGS$API_KEY = "SETTINGS$API_KEY",
  SETTINGS$API_KEY_UPDATE_PLACEHOLDER = "SETTINGS$API_KEY_UPDATE_PLACEHOLDER",
  SETTINGS$API_KEY_UPDATE_HELP = "SETTINGS$API_KEY_UPDATE_HELP",
  SETTINGS$BASE_URL_PLACEHOLDER = "SETTINGS$BASE_URL_PLACEHOLDER",
  SETTINGS$SET_AS_DEFAULT_CONFIGURATION = "SETTINGS$SET_AS_DEFAULT_CONFIGURATION",
  SETTINGS$TEST_BEFORE_SAVING = "SETTINGS$TEST_BEFORE_SAVING",
  SETTINGS$TEST_CONFIGURATION = "SETTINGS$TEST_CONFIGURATION",
  SETTINGS$NO_CHANGES = "SETTINGS$NO_CHANGES",
  SETTINGS$LAST_TEST_STATUS = "SETTINGS$LAST_TEST_STATUS",
  SETTINGS$SET_AS_DEFAULT = "SETTINGS$SET_AS_DEFAULT",
  SETTINGS$NOT_TESTED = "SETTINGS$NOT_TESTED",
  ...
  SETTINGS$NAV_ACCOUNT = "SETTINGS$NAV_ACCOUNT",
  SETTINGS$USERNAME = "SETTINGS$USERNAME",
  SETTINGS$USERNAME_LOADING = "SETTINGS$USERNAME_LOADING",
  SETTINGS$USERNAME_SAVED_SUCCESSFULLY = "SETTINGS$USERNAME_SAVED_SUCCESSFULLY",
  SETTINGS$FAILED_TO_SAVE_USERNAME = "SETTINGS$FAILED_TO_SAVE_USERNAME",
  SETTINGS$ACCOUNT_ACTIONS = "SETTINGS$ACCOUNT_ACTIONS",
  SETTINGS$LOGOUT_DESCRIPTION = "SETTINGS$LOGOUT_DESCRIPTION",
  SETTINGS$SIGN_OUT = "SETTINGS$SIGN_OUT",
  SETTINGS$SIGNING_OUT = "SETTINGS$SIGNING_OUT",
  ...
  SETTINGS$LOGOUT_SUCCESS = "SETTINGS$LOGOUT_SUCCESS",
